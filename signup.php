...
<head>
    <meta charset="UTF-8">
    <title>Signup Doghoneymoon</title>
...
<body>
   <main>
       <div class="container">
       <div class="sectionsearch1 p-0">
           <div class="d-flex justify-content-center">
               <div class="d-flex">
                 <form action="searchmentor.php" method="post">
                   <div class="form-group">
                   <h1>  sign - up <span  style="color: #FF1493;">!  </span></h1><br>
                   <input type="search" name="search" placeholder="Owner name" class="form-control searchbox "><br>
                   <input type="search" name="search" placeholder="Contact number" class="form-control searchbox "><br>
                   <input type="search" name="search" placeholder="Owner city" class="form-control searchbox "><br>
                   <input type="search" name="search" placeholder="Email id" class="form-control searchbox "><br>
                   <input type="search" name="search" placeholder="Create password" class="form-control searchbox "><br>
                   <input type="search" name="search" placeholder="Dog name" class="form-control searchbox "><br>
                   ...
                   <label for="dog breed">Select dog breed</label>
                    ...
                    <br>
                    <label for="dog breed">Select dog location</label>
                   ...
                   <br>
                   <label for="dog breed">Select dog age</label>
                    <select class="form-control" id="exampleFormControlSelect1" name="city">
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
                   ...
                   <br>
                   <label for="dog breed">Select dog gender</label>
                    <select class="form-control" id="exampleFormControlSelect1" name="city">
                      <option>Male</option>
                   ...
                   <br>
                   <input type="submit" name="submit" value="register" class="btn " class="searchbtn" style="margin-top:10%; margin-left:13%; background: #FF1493; color:white; width:180px;height:50px;">
                   </div>
                 </form>
               </div>
           </div>
